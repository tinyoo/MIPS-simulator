...
typedef union {
    ...
    /* friend bool operator==(const Instruction &ob1, const Instruction &ob2);
    bool operator==(const Instruction &rhs); */
} Instruction;

/*
bool operator==(const Instruction &ob1, const Instruction &ob2) {
    return (ob1.opcode.opcode == ob2.opcode.opcode && ob1.rtype.funct == ob2.rtype.funct);
}

bool Instruction :: operator==(const Instruction &rhs) {
    return (opcode.opcode == rhs.opcode.opcode && rtype.funct == rhs.rtype.funct);
}
*/
